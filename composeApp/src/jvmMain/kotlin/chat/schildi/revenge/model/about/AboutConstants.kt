...
val ThirdPartyAcknowledgements = persistentListOf(
    ...
    ThirdPartyAcknowledgement(
        ...
        author = "Nick",
        authorUrl = "https://pictogrammers.com/contributor/Croutonix/",
        license = "Apache-2.0",
        licenseUrl = "https://www.apache.org/licenses/LICENSE-2.0.txt",
    ),
    ThirdPartyAcknowledgement(
        name = "duck",
        url = "https://pictogrammers.com/library/mdi/icon/duck/",
        author = "Austin Andrews",
        authorUrl = "https://pictogrammers.com/contributor/Templarian/",
        license = "Apache-2.0",
        licenseUrl = "https://www.apache.org/licenses/LICENSE-2.0.txt",
    ),
    ThirdPartyAcknowledgement(
        name = "sword",
        url = "https://pictogrammers.com/library/mdi/icon/sword/",
        author = "Austin Andrews",
        authorUrl = "https://pictogrammers.com/contributor/Templarian/",
        license = "Apache-2.0",
        licenseUrl = "https://www.apache.org/licenses/LICENSE-2.0.txt",
