...
enum class DestinationEnum(
    ...
    CreateRoom("CreateRoom", listOf("createRoom")),
    StartChat("StartChat", listOf("startChat")),
    ConversationThread("ConversationThread", listOf("thread")),
    ConversationPins("ConversationPins", listOf("pinnedMessages")),
...
val SUGGESTED_DESTINATION_STRINGS = listOf(
    ...
    DestinationEnum.CreateRoom.aliases[0],
    DestinationEnum.StartChat.aliases[0],
    DestinationEnum.ConversationPins.aliases[0],
...
val ALLOWED_DESTINATION_STRINGS = listOf(
    ...
    DestinationEnum.CreateRoom.allDestinationNames(),
    DestinationEnum.StartChat.allDestinationNames(),
    DestinationEnum.ConversationPins.allDestinationNames(),
